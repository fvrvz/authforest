...
This document describes the improved GitHub Actions workflows for the auth-service-go project.
...
- `develop` → `ghcr.io/fvrvz/auth-service-go:develop`
- `v1.2.3` → `ghcr.io/fvrvz/auth-service-go:v1.2.3`, `1.2`, `1`, `latest`
- Commit → `ghcr.io/fvrvz/auth-service-go:develop-sha123abc`
...
Images are available at: `ghcr.io/fvrvz/auth-service-go`
...
```bash
# Latest stable
docker pull ghcr.io/fvrvz/auth-service-go:latest

# Specific version
docker pull ghcr.io/fvrvz/auth-service-go:v1.0.0

# Development
docker pull ghcr.io/fvrvz/auth-service-go:develop
```
